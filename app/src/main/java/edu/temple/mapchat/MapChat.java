...
public class MapChat extends AppCompatActivity implements ListFrag.OnUpdatePartnersListener, OnMapReadyCallback, LocationListener, MyAdapter.KeyHolder{
    ...
    public String getKey(String user){
        //TODO check for key and return it
        return null;
    }
}
